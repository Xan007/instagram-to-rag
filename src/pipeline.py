...
def query_knowledge(
    ...
    *,
    ...
    """Query the knowledge base and return the grounded answer plus sources."""
    from src.rag.query_engine import QueryEngine

    engine = QueryEngine()
    return engine.query(question=question, username=creator, top_k=top_k, min_score=min_score, mode=mode)
